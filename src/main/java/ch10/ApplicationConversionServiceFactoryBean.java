...
public class ApplicationConversionServiceFactoryBean extends FormattingConversionServiceFactoryBean {
    ...
    public Formatter<DateTime> getDateTimeFormatter(){
        return new Formatter<DateTime>() {
            @Override
            public DateTime parse(String datetTimeString, Locale locale) throws ParseException {
                System.out.println("Parsing date string: " + datetTimeString);
                return dateFormat.parseDateTime(datetTimeString);
            }
