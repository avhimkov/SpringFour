...
public class ConvFormatServExample {
    public static void main(String[] args) {
        ...
        ctx.load("classpath:META-INF/conv-format-service-app-context.xml");
        ctx.refresh();
        ...
        System.out.println("Birthdate of contact id : " + conversionService.convert(chris.getBirthDate(), String.class));
    }
}
