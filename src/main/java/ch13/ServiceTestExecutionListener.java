...
public class ServiceTestExecutionListener implements TestExecutionListener {
    ...
    @Override
    public void afterTestClass(TestContext argO) throws Exception {
    }
    @Override
    public void afterTestMethod(TestContext argO) throws Exception {
    ...
    @Override
    public void beforeTestClass(TestContext argO) throws Exception {
    }
    ...
    @Override
    public void prepareTestInstance(TestContext argO) throws Exception {
    }
}
