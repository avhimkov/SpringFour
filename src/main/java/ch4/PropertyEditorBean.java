...
public class PropertyEditorBean {
    ...
    public static class CustomPropertyEditorRegistrar implements PropertyEditorRegistrar {
        @Override
        public void registerCustomEditors(PropertyEditorRegistry registrar) {
            SimpleDateFormat dateFormat = new SimpleDateFormat("MM/dd/yyyy");
            registrar.registerCustomEditor(Data.class, new CustomDateEditor(dateFormat, true));
            registrar.registerCustomEditor(String.class, new StringTrimmerEditor(true));
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ctx.load("classpath:MEAT-INF/app-context-xml.xml");
        ctx.refresh();
